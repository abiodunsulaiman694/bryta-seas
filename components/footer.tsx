        ...
        <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div>
            ...
            <ul className="mt-2 space-y-2">
              <li>
                <Link href="/services" className="text-sm text-gray-600 hover:text-[#0077B6]">
                  Services
                </Link>
              </li>
              <li>
                <Link href="/insights" className="text-sm text-gray-600 hover:text-[#0077B6]">
                  Insights
                </Link>
              </li>
              <li>
                <Link href="/about" className="text-sm text-gray-600 hover:text-[#0077B6]">
                  About
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <address className="mt-2 not-italic text-sm text-gray-600">
              ...
              <p>
                <a href="tel:+18722749553" className="hover:text-[#0077B6]">
                  +1 (872) 274-9553
                </a>
              </p>
            </address>
          ...
          <div>
            ...
            <div className="mt-4 flex gap-2">
              ...
              <Button size="sm" className="bg-[#44841A] hover:bg-[#44841A]/90 text-white">Subscribe</Button>
            </div>
          </div>
        </div>
